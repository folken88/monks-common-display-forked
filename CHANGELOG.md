...
# Version 13.1.0-fork.0

Fork metadata update (module id, author, repo links).

Added a common display combatant portrait next to the combat tracker during combat.
