...
export const registerSettings = function () {
	...
	let modulename = "monks-common-display-forked";
	...
	game.settings.register(modulename, "show-combat-portrait", {
		name: i18n("MonksCommonDisplay.show-combat-portrait.name"),
		hint: i18n("MonksCommonDisplay.show-combat-portrait.hint"),
		scope: "world",
		config: true,
		default: true,
		type: Boolean,
	...
	game.settings.register(modulename, "combat-portrait-size", {
		name: i18n("MonksCommonDisplay.combat-portrait-size.name"),
		hint: i18n("MonksCommonDisplay.combat-portrait-size.hint"),
		scope: "world",
		config: true,
		default: "large",
		type: String,
		choices: {
			small: i18n("MonksCommonDisplay.combat-portrait-size.small"),
			medium: i18n("MonksCommonDisplay.combat-portrait-size.medium"),
			large: i18n("MonksCommonDisplay.combat-portrait-size.large")
		},
		onChange: () => {
			MonksCommonDisplay.updateCombatPortrait();
		}
